...
public struct TwitterAPIType: Codable {
  ...
  public init(
    ...
    displayTextRange: [Int]?, entities: Entities?, extendedEntities: ExtendedEntities?,
    source: String?, inReplyToStatusID: JSONNull?, inReplyToStatusIDStr: JSONNull?,
    inReplyToUserID: JSONNull?, inReplyToUserIDStr: JSONNull?, inReplyToScreenName: JSONNull?,
    user: User?, geo: JSONNull?, coordinates: JSONNull?, place: JSONNull?, contributors: JSONNull?,
    isQuoteStatus: Bool?, retweetCount: Int?, favoriteCount: Int?, replyCount: Int?,
    favorited: Bool?, retweeted: Bool?, possiblySensitive: Bool?,
    possiblySensitiveAppealable: Bool?, possiblySensitiveEditable: Bool?, lang: String?,
    supplementalLanguage: JSONNull?, selfThread: SelfThread?
  ) {
...
public struct Entities: Codable {
  ...
  public init(
    hashtags: [JSONAny]?, symbols: [JSONAny]?, userMentions: [JSONAny]?, urls: [JSONAny]?,
    media: [Media]?
  ) {
...
public struct Media: Codable {
  ...
  public init(
    id: Double?, idStr: String?, indices: [Int]?, mediaURL: String?, mediaURLHTTPS: String?,
    url: String?, displayURL: String?, expandedURL: String?, type: String?,
    originalInfo: OriginalInfo?, sizes: Sizes?, videoInfo: VideoInfo?, mediaKey: String?,
...
public struct User: Codable {
  ...
  public let profileLinkColor, profileSidebarBorderColor, profileSidebarFillColor,
    profileTextColor: String?
  public let profileUseBackgroundImage, hasExtendedProfile, defaultProfile,
  ...
  public init(
    id: Int?, idStr: String?, name: String?, screenName: String?, location: String?, url: String?,
    userDescription: String?, protected: Bool?, followersCount: Int?, friendsCount: Int?,
    listedCount: Int?, createdAt: String?, favouritesCount: Int?, utcOffset: JSONNull?,
    timeZone: JSONNull?, geoEnabled: Bool?, verified: Bool?, statusesCount: Int?, mediaCount: Int?,
    lang: JSONNull?, contributorsEnabled: Bool?, isTranslator: Bool?, isTranslationEnabled: Bool?,
    profileBackgroundColor: String?, profileBackgroundImageURL: String?,
    profileBackgroundImageURLHTTPS: String?, profileBackgroundTile: Bool?, profileImageURL: String?,
    profileImageURLHTTPS: String?, profileBannerURL: String?, profileLinkColor: String?,
    profileSidebarBorderColor: String?, profileSidebarFillColor: String?, profileTextColor: String?,
    profileUseBackgroundImage: Bool?, hasExtendedProfile: Bool?, defaultProfile: Bool?,
    defaultProfileImage: Bool?, hasCustomTimelines: Bool?, following: JSONNull?,
    followRequestSent: JSONNull?, notifications: JSONNull?, businessProfileState: String?,
    translatorType: String?, withheldInCountries: [JSONAny]?, requireSomeConsent: Bool?
  ) {
    self.id = id
    self.idStr = idStr
    self.name = name
